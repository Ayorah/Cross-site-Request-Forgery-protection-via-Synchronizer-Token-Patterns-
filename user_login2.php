    ...
    <body>
	 ...
	 <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            ...
            <?php
              if(!isset($_COOKIE['Assignment2_session_cookie'])) {
                echo "<li><a href='user_profile2.php'></t>Profile</t></a></li>";
              }
            ?>
          ...
          <?php
            if(!isset($_COOKIE['Assignment2_session_cookie'])) {
              echo "<li><a href='user_login2.php'> Log In </a></li>";
            }
          ?>

          <?php
            if(isset($_COOKIE['Assignment2_session_cookie'])) {
              echo "<li><a href='user_logout2.php'> Log Out </a></li>";
            }
          ?>
...
<div class="container-fluid bg-1 text-center">
          <form action ='user_login2.php' method='POST' enctype='multipart/form-data'>
